...
\newtcbtheorem[number within=section]{Definition}{Definition}{enhanced,
	before skip=2mm, colback=red!5,colframe=red!80!black,boxrule=0.5mm,
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  ...
	  \begin{tikzpicture}[remember picture, overlay]%
		  ...
		  \pgftext[right,x=17cm,y=0.2cm]{\color{white}\Huge\sc\bfseries \contentsname};%
	  \end{tikzpicture}}%
	\@starttoc{toc}}
\makeatother
...
\newcommand{\eqt}[1]{\begin{equation}#1\end{equation}}
