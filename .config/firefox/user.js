...
user_pref("browser.urlbar.speculativeConnect.enabled", false); // Stop Firefox from preemptively making connection to URL when enabling bookmark search in the address bar
